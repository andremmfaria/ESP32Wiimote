...
uint16_t make_cmd_remote_name_request(uint8_t* buf, struct bd_addr_t bdAddr, uint8_t psrm, uint16_t clkofs);
uint16_t make_cmd_create_connection(uint8_t* buf, struct bd_addr_t bdAddr, uint16_t pt, uint8_t psrm,
