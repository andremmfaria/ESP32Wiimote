...
- startup order is Wi-Fi layer -> filesystem mount -> static page routes -> API routes
- `/openapi.json` is generated by the router and does not depend on filesystem content
